  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final primaryColor = widget.isDestructive ? Colors.redAccent : AppColors.primaryRoyalBlue;
        final bgOpacity = widget.isDestructive ? 0.08 : 0.08;
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        height: iconBoxSize,
                        decoration: BoxDecoration(
                          color: primaryColor.withValues(alpha: bgOpacity),
                          shape: BoxShape.circle,
                        ),
                        child: Icon(
                          widget.icon,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              overflow: TextOverflow.ellipsis,
                              style: AppTypography.bodyMedium.copyWith(
                                color: widget.isDestructive ? Colors.redAccent : AppColors.textPrimary,
                                fontWeight: FontWeight.w900,
