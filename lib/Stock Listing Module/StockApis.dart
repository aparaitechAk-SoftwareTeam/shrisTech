...
class StockRepository implements IStockRepository {
  ...
  Future<ProductModel> updateProduct({
    ...
    final cached = _cachedById(productId);
    final optimistic = cached?.copyWith(
      weights: (cached.weights).copyWith(
    ...
    final merged = (updated.images.isEmpty && cached != null && cached.images.isNotEmpty)
        ? updated.copyWith(
            productName: updated.productName.isNotEmpty ? updated.productName : cached.productName,
            productCode: updated.productCode.isNotEmpty ? updated.productCode : cached.productCode,
            description: updated.description.isNotEmpty ? updated.description : cached.description,
            images: cached.images,
          )
        : updated;

    _replaceCachedProduct(merged);
    return merged;
  }
