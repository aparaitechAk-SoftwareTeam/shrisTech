                            ...
                            SliverPadding(
                              ...
                              sliver: SliverList(
                                delegate: SliverChildListDelegate([
                                  if (_isEditMode)
                                    _EditModeNotice(
                                      product: widget.initialProductData!,
                                    )
                                  else
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        AddProductSectionHeader(
                                          ...
                                          subtitle: _isEditMode
                                              ? 'Update gross and stone weight only. Net weight is recalculated by the backend.'
    ...
    try {
      if (_isEditMode) {
        ...
        final updatedProduct = existing.copyWith(
          weights: existing.weights.copyWith(
...
class _EditModeNotice extends StatelessWidget {
  final stock.ProductModel product;

  const _EditModeNotice({required this.product});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Only gross weight and stone weight will be updated. Images, category, price and quantity remain unchanged.',
